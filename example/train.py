...
# imgs_mask_train /= 255.  # scale masks to [0, 1]. We divide by 255 for RGB normalization
    ...
    model.fit(imgs_train, imgs_mask_train, batch_size=4, nb_epoch=1000, verbose=1, shuffle=True,
